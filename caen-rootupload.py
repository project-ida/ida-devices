...
parser = argparse.ArgumentParser(description="Automate Rclone copy between source and destination.")
...
parser.add_argument("--interval", type=int, default=60, help="Copy interval in seconds (default: 60)")
...
while True:
    ...
    # Print a message indicating the copy is complete
