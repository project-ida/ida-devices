...
from an external JSON config file (e.g., google_sheet_config.json),
...
# These can be overridden in google_sheet_config.json under keys 'col_run_name', 'col_setup', 'col_end', 'header_row'
COL_RUN_NAME = cfg.get('col_run_name', 7)   # G
COL_SETUP    = cfg.get('col_setup', 12)     # L
COL_END      = cfg.get('col_end', 17)       # Q
HEADER_ROW   = cfg.get('header_row', 1)
